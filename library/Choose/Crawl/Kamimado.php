...
class Choose_Crawl_Kamimado extends Choose_Crawl
{
    protected $_name = 'かみまど';

    public function collect()
    {
        $this->_httpOptions['maxredirects'] = 2;

        $baseUrls = array(
            '美容師'        => 'http://kamimado.viceviza.com',
            'ネイル・まつげ' => 'http://nail.viceviza.com',
            'リラク'        => 'http://rela.viceviza.com',
        );
