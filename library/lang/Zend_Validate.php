...
return array(
    // ADD
    "'%value%' is not a valid email address in the basic format local-part@hostname" => "'%value%' はメールアドレスの基本的な形式ではありません",
    ...
    "'%value%' was not found in the haystack" => " '%value%' が一覧の中に見つかりませんでした",
    ...
    "Value is required and can't be empty" => "必須項目です。",
